...
<head>
    <meta charset="UTF-8">
    <title><?php echo $username_guest; ?></title>
...
<body class="conf">
    <div class="sidebar">
        ...
        <ul class="menu">
            ...
            <li>
                <a href="ds_user.php" class="chon"><?php echo $username_guest ?></a>
            </li>
            <li>
    ...
    <div class="container">
        <div class="row">
            <a href="ds_user.php?code=2" class="add" style="float:right;">Trở lại</a>
        </div>
        <div class="row">
